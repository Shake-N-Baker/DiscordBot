...
public enum SpireCard {
    ...
    BASH("Bash", 4, CardType.ATTACK, "Deal 8 damage to the front enemy and apply 2 Vulnerable.",
            (e, s) -> { e.applyVulnerableToFront(s, 2); e.dealDamageToFront(s, 8); }),
    CLEAVE("Cleave", 4, CardType.ATTACK, "Deal 8 damage to ALL enemies.",
    ...
    WHIRLWIND("Whirlwind", 5, CardType.ATTACK, "Deal 6 damage to ALL enemies twice.",
            (e, s) -> { e.dealDamageToAll(s, 6); e.dealDamageToAll(s, 6); }),
    CRUSHING_BLOW("Crushing Blow", 5, CardType.ATTACK, "Deal 10 damage to the front enemy and apply 3 Vulnerable.",
    ...
    DROPKICK("Dropkick", 3, CardType.ATTACK, "Deal 8 damage to the front enemy. If it is Vulnerable, gain 1 energy and draw 1 card.",
    ...
    ENTRENCH("Entrench", 4, CardType.SKILL, "Double your current Block.",
            (e, s) -> e.doubleBlock(s)),
